...
export interface IContentfulMapsBuildRoleProps extends RoleProps {
  readonly stages: string[]
  readonly artifactBucket: Bucket
}

export class ContentfulMapsBuildRole extends Role {
  constructor(scope: cdk.Construct, id: string, props: IContentfulMapsBuildRoleProps) {
...
export default ContentfulMapsBuildRole
