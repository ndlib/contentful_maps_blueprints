...
export interface IContentfulMapsBuildProjectProps extends codebuild.PipelineProjectProps {
...
export default class ContentfulMapsBuildProject extends codebuild.PipelineProject {
  constructor(scope: cdk.Construct, id: string, props: IContentfulMapsBuildProjectProps) {
    const serviceStackPrefix = scope.node.tryGetContext('serviceStackName') || 'contentfulmaps'
    const projectProps = {
      environment: {
